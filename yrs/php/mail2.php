...
$BccMail = "yrs-conduct@ml.yokohama-rs.com";
...
$require = array('保護者','名前','ふりがな','生年月日','学年','Email','電話番号');
...
$refrom_name = "横浜ラグビースクール体験申し込み";

// 差出人に送信確認メールを送る場合のメールのタイトル（上記で1を設定した場合のみ）
$re_subject = "体験申し込みありがとうございます";
...
体験申し込みの連絡ありがとうございます。
担当者より、登録メールに連絡させて頂きます。
お待ちいただけるようよろしくお願いいたします。
...
<?php }else{ ?>
<div align="center"><h3>確認画面</h3></div>
